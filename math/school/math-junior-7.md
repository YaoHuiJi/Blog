- <h1 align = "center">初中数学 摘要</h1>
  ...
  就是n各相同的数相乘，比如![img](http://latex.codecogs.com/gif.latex?a%5En)，就是“a的n次方”，乘方的结果叫做**幂（power）** ，在![img](http://latex.codecogs.com/gif.latex?a%5En)中，a叫做**底数（base number）**，n叫做**指数（exponent）**，当把![img](http://latex.codecogs.com/gif.latex?a%5En)看作a的n次方的结果时，可以把它读成“a的n次幂”

  <h3 id="integral_expression">整式</h3>

  - 单项式与多项式统称整式
  - 单项式中的数字因数叫做单项式的**系数（coefficient）**
  - 单项式中所有字母的指数的和叫做这个单项式的**次数（degree of a monomial）**，例如![img](http://latex.codecogs.com/gif.latex?2a%5E3)的次数是3
  - 每个单项式叫做多项式的**项（polynomial）**
  - 多项式里，次数最高项的次数，叫做这个**多项式的次数**，例如![img](http://latex.codecogs.com/gif.latex?2a%5E3b%5E2+3b)的次数是5
  ...
  - 任何不等于0的数的0次幂都等于1
  - **平方差公式：**两个数的和与这两个数的差的积，等于这两个数的平方差，即：![img](https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=3972351108,2312720346&fm=58)
  - **完全平方公式：**![img](https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=197666933,2478185337&fm=58)
  ...
  - 若k个数x1,x2,......,xn的权分别是f1,f2,…...fk，那么 ![img](http://pic.baike.soso.com/p/20130713/20130713181812-666140510.jpg)叫做这k个数的**加权平均值**(n=f1+f2+......+fk)
  ...
  - **总体方差**：![img](http://wiki.mbalib.com/w/images/math/1/a/2/1a28eba1b3ca17b3cc16055d9ef32662.png)
  - **样本方差**：![img](http://wiki.mbalib.com/w/images/math/2/8/d/28d5626689ac08c8467e2b542280261d.png)
  - 一组数据中最大值与最小值的差成为这组数据的**极差**
  - **平均差（mean deviation）：**![img](https://raw.githubusercontent.com/YaoHuiJi/Blog/master/images/%E5%B9%B3%E5%9D%87%E5%B7%AE.jpg)
  - **加权平均差（average deviation）：**![img](https://raw.githubusercontent.com/YaoHuiJi/Blog/master/images/%E5%8A%A0%E6%9D%83%E5%B9%B3%E5%9D%87%E5%B7%AE.jpg)(f是权重)
  ...
  - **解一元二次方程的几个方法**，思路都是想办法降次
    ...
    - 通过把一元二次方程配成完全平方![img](https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=197666933,2478185337&fm=58)的形式来解一元二次方程的办法，叫做**配方法**
